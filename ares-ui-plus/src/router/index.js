    ...
    children: [
      {
        path: 'blog',
        component: () =>
          import('@/layout-blog/components/Index'),
        name: '主页',
      },
      {
        path: '/details/:contentId',
        component: () =>
          import('@/layout-blog/components/Details'),
        name: 'details',
      },
      {
        path: '/archives',
        component: () =>
          import('@/layout-blog/components/Archives'),
        name: 'archives',
      },
      {
        path: '/tag',
        component: () =>
          import('@/layout-blog/components/Tag'),
        name: 'tag',
      },
      {
        path: '/updateinfo',
        component: () =>
          import('@/layout-blog/components/UpdateInfo'),
        name: 'updateinfo',
      },
    ],
  },
    ...
    children: [
      {
        ...
        component: () =>
          import('@/views/monitor/mq/bindings'),
        name: 'Bindings',
        meta: { title: '绑定关系' },
      },
    ],
    ...
    children: [
      {
        ...
        component: () =>
          import('@/views/flowable/definition/model'),
        name: 'Model',
    ...
    children: [
      {
        ...
        component: () =>
          import('@/views/flowable/task/record/index'),
        name: 'Record',
