          ...
          <div class="left-wrapper-fixed">
            ...
            <div class="menu-wrapper">
              <ul>
                ...
                >
                  <el-icon class="iconfont"><House /></el-icon>
                  <p>Home</p>
                </li>
                <li
                ...
                >
                  <el-icon class="iconfont"><Notebook /></el-icon>
                  <p>Archives</p>
                </li>
                <li
                ...
                >
                  <el-icon class="iconfont"><Collection /></el-icon>
                  <p>Tag</p>
                </li>
                <li class="">
                  <el-icon class="iconfont"><Link /></el-icon>
                  <p>Github</p>
                </li>
              </ul>
            </div>
      ...
      <div class="main-wrapper">
        <div class="nav-wrapper" :class="{ 'nav-shadow': navShadow }">
          ...
          <el-icon
            ...
            style="padding: 10px 1px 1px; float: right; width: 2em; height: 2em"
            ><Search
          /></el-icon>
          <div
...
// .nav-wrapper i:nth-child(3){/*//   float: right;*//*//*/}
header {
