...
package com.ares.generator.persistence.manager;
...
public interface GenPropertiesManager extends BaseManager<GenPropertiesDto, GenPropertiesQuery> {

    GenPropertiesDto getByUser();
