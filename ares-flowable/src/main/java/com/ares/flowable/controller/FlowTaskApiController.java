...
public class FlowTaskApiController extends BaseController {
    ...
    public Object myProcess(@ApiParam(value = "当前页码", required = true) @RequestParam Integer pageNum,
    ...
    public Object todoList(@ApiParam(value = "当前页码", required = true) @RequestParam Integer pageNum,
                           @ApiParam(value = "每页条数", required = true) @RequestParam Integer pageSize) {
    ...
    public Object finishedList(@ApiParam(value = "当前页码", required = true) @RequestParam Integer pageNum,
                               @ApiParam(value = "每页条数", required = true) @RequestParam Integer pageSize) {
    ...
    @ApiOperation(value = "流程列表", response = Object.class)
