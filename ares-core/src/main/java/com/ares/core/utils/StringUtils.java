...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
     ...
     * @return 结果
     */
    public static String formatter(String strPattern, final Object... argArray) {
        String result = strPattern;
        boolean finished = false;
        if (!StringUtils.isEmpty(strPattern) && !StringUtils.isEmpty(argArray)) {
            final int strPatternLength = strPattern.length(); // 初始化定义好的长度以获得更好的性能
    ...
    public static String toUpperScoreCase(String s) {
        if (s == null) {
            return null;
        }
        StringBuilder sb = new StringBuilder();
