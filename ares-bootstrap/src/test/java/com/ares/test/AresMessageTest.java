...
import com.ares.message.service.IDisruptorMessageService;
...
public class AresMessageTest extends AresBaseTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        AresMessageProducer<String> producer = new AresMessageProducer("生产者1", disruptorQueue, "com/ares/test", new AtomicInteger(1));
    ...
    @Test
    public void test(){
        AresMessageUtil.sendMessage("com/ares/test","this is a test!");
    }
